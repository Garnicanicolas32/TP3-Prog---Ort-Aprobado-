			   ...
			   <div class="card-header">
					   ...
					   <form action="" method="post" class="form-inline">
							  <div class="form-group"><label for="exampleInputName2" class="pr-1  form-control-label">Name</label><input type="text" id="exampleInputName2" placeholder="nombre" required="" class="form-control"></div>
							   <div class="form-group"><label for="exampleInputName2" class="pr-1  form-control-label">Imagen</label><input type="text" id="exampleInputName2" placeholder="imagen" required="" class="form-control"></div>
					   </form>
					   </div>
