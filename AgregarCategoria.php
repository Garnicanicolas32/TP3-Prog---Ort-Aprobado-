...
<body>
    ...
    <div class="card">
        <div class="card-header"><strong>Agregar Categoria</strong></div>
        <div class="card-body card-block">
            <div class="form-group">
			<input type="hidden" name="accion" id="accion" value="<?php echo $accion; ?>">
			<input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
                <label for="nombre" class=" form-control-label">Nombre</label>
                <input type="text" name="nombre" id="nombre" placeholder="Ingresa el nombre de la nueva categoria" class="form-control" value="<?php echo $resultado->nombre; ?>">
            </div>  
        </div>
        <button type="button" onclick="AgregarCat(); "class="btn btn-secondary">Agregar</button>  
    </div>
	</form>
